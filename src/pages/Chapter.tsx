...
export default function Chapter() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Consider chapter read when user scrolls through 80% of content
  ...
  useEffect(() => {
    if (hasReachedBottom && !viewCounted && novelId && chapterId) {
  ...
  }, [hasReachedBottom, viewCounted, novelId, chapterId]);
  ...
  useEffect(() => {
    const fetchChapterData = async () => {
      ...
      try {
        ...
        // Reset view state when changing chapters
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        <div 
          ref={contentRef} 
          className="prose max-w-none mb-8 max-h-[70vh] overflow-y-auto"
        >
